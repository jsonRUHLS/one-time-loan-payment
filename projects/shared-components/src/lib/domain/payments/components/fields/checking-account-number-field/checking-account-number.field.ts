...
@Component({
  selector: 'shared-checking-account-number-field',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './checking-account-number.field.html',
  styleUrl: './checking-account-number.field.scss',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CheckingAccountNumberField),
      multi: true
    }
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CheckingAccountNumberField implements OnInit, ControlValueAccessor {
